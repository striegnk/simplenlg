 ...
 * @version 4.0
 */
abstract class ComparativeCorrelativePhraseHelper {
	...
	static NLGElement realise(SyntaxProcessor parent,
							  ComparativeCorrelativePhraseElement phrase) {
	 ...
	 *            coordination.
	 */
	private static void setChildFeatures(ComparativeCorrelativePhraseElement phrase,
			NLGElement child) {
